...
-- ----------------------------
-- Table structure for biz_workflowToken
-- ----------------------------
CREATE TABLE IF NOT EXISTS `biz_workflowToken` (
  `id` varchar(36) NOT NULL,
  `finishTime` datetime DEFAULT NULL,
  `receiveTime` datetime DEFAULT NULL,
  `startTime` datetime DEFAULT NULL,
...
-- ----------------------------
-- Table structure for biz_workflowTokenbak
-- ----------------------------
CREATE TABLE IF NOT EXISTS `biz_workflowTokenbak` (
  `id` varchar(36) NOT NULL,
  `finishTime` datetime DEFAULT NULL,
  `receiveTime` datetime DEFAULT NULL,
  `startTime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `h_biz_query_action` (
  ...
  `schemaCode` varchar(40) DEFAULT NULL,
  `scopedSlots` varchar(2000) DEFAULT NULL,
  `serviceCode` varchar(40) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for h_biz_resource
-- ----------------------------
CREATE TABLE IF NOT EXISTS `h_biz_resource` (
  `id` varchar(120) NOT NULL,
  `bizObjectId` varchar(36) NOT NULL,
  `bizPropertyCode` varchar(40) NOT NULL,
  `createdTime` datetime DEFAULT NULL,
  ...
  `refId` varchar(500) NOT NULL,
  `schemaCode` varchar(36) NOT NULL,
  `storageMethod` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_biz_resource_schema_object_property` (`schemaCode`,`bizObjectId`,`bizPropertyCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `h_biz_service` (
  ...
  `name` varchar(50) DEFAULT NULL,
  `protocolAdapterCode` varchar(40) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `h_org_department` (
  ...
  `sourceParentId` varchar(40) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `h_org_user` (
  ...
  `sourceParentId` varchar(50) DEFAULT NULL,
  `status` varchar(40) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for h_perm_biz_schema
-- ----------------------------
CREATE TABLE IF NOT EXISTS `h_perm_biz_schema` (
  `id` varchar(120) NOT NULL,
  `createdTime` datetime DEFAULT NULL,
  `creater` varchar(120) DEFAULT NULL,
  `deleted` bit(1) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for h_perm_schema_condition
-- ----------------------------
CREATE TABLE IF NOT EXISTS `h_perm_schema_condition` (
  `id` varchar(120) NOT NULL,
  `createdTime` datetime DEFAULT NULL,
  `creater` varchar(120) DEFAULT NULL,
  `deleted` bit(1) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for h_system_login_log
-- ----------------------------
CREATE TABLE IF NOT EXISTS `h_system_login_log` (
  `id` varchar(120) NOT NULL,
  `browser` varchar(50) DEFAULT NULL,
  `clientAgent` varchar(500) DEFAULT NULL,
  `ipAddress` varchar(20) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for h_workflow_bizform
-- ----------------------------
CREATE TABLE IF NOT EXISTS `h_workflow_bizform` (
  `id` varchar(120) NOT NULL,
  `creater` varchar(120) DEFAULT NULL,
  `createdTime` datetime DEFAULT NULL,
  `deleted` bit(1) DEFAULT NULL,
  ...
  `modifiedTime` datetime DEFAULT NULL,
  `remarks` varchar(200) DEFAULT NULL,
  `bizFormCode` varchar(40) DEFAULT NULL,
  `refWorkflowCode` varchar(40) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for h_workflow_log
-- ----------------------------
...
CREATE TABLE IF NOT EXISTS `h_workflow_template` (
  ...
  `modifier` varchar(120) DEFAULT NULL,
  `remarks` varchar(200) DEFAULT NULL,
  `activateEventHandler` longtext,
  `cancelEventHandler` longtext,
  `content` longtext,
  `endEventHandler` longtext,
  `startEventHandler` longtext,
